...
Table~\ref{tab:platform_comparison} compares Amazon ECS with Fargate launch type and Azure Container Apps across all configurations, directly addressing Research Question RQ1 (platform performance comparison) and RQ3 (consistency and predictability).
...
\begin{tabular}{lll}
\toprule
\textbf{Metric} & \textbf{AWS ECS} & \textbf{Azure Container Apps} \\
\midrule
