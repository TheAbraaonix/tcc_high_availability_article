...
\toprule
\textbf{Study} & \textbf{Platforms} & \rotatebox{90}{\textbf{Identical HW}} & \rotatebox{90}{\textbf{AI Workload}} & \rotatebox{90}{\textbf{Scaling Comparison}} & \rotatebox{90}{\textbf{CPU-focused}} \\
\midrule
...
\bottomrule
\multicolumn{6}{l}{\footnotesize Note: checkmark = Yes; cross = No; N/A = Not Applicable for platform-agnostic frameworks.} \\
\end{tabular}
\end{table*}
